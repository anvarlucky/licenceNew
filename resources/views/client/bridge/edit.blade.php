    ...
    <div class="container-fluid p-5">
        <div class="col-md-12 px-0 table-box">
            ...
            <div class="form-group col-md-12">
                {{Form::open(['route' => ['bridge.update',$bridge->id],'method' => 'put'])}}
                @csrf
                @include('client.bridge._form')
                <div class="form-group">
                    <label for="">Litsenziya yangi raqami(Agar zarur bo'lsa)</label>
                    {{Form::text('licence_number_new', $bridge->licence_number_new??null, ['class' => 'form-control'])}}
                </div>
                <div class="form-group">
