                            ...
                            <div class="account-info">
                                <ul class="mb-5 pb-3">
                                    ...
                                    <li class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-md-6">
                                            <p class="account-info-text">
                                                {{\Carbon\Carbon::parse($dangerous->licence_given_date)->format('d-m-Y')}}
                                            </p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                ...
                                <ul class="border-A5C9FF pt-4">
                                    ...
                                    <li class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-md-6">
                                            @foreach($dangerous->types as $type)
