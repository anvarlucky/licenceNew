            ...
            <div class="table-responsive">
                <table class="table table-hover" id="org_table">
                    ...
                    <tr>
                        ...
                        <th class="darkblue-color text-center align-top">Tashkilot INN
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($mauntaineeringes as $key => $mauntaineering)
                        <tr>
                            ...
                            <td class="darkblue-color d-flex align-items-center justify-content-end">
                                <a href="{{route('mauntaineering.edit', $mauntaineering->id)}}" class="btn btn-outline-primary mr-3 text-nowrap">O`zgartirish</a>
                            </td>
                            ...
                            <td class="darkblue-color text-center text-nowrap align-middle">{{$mauntaineering->organization_inn}}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
