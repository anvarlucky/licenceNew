                            ...
                            <div class="account-info">
                                <ul class="mb-5 pb-3">
                                    ...
                                    <li class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-md-6">
                                            <p class="account-info-text">
                                                {{\Carbon\Carbon::parse($defence->licence_given_date)->format('d-m-Y')}}
                                            </p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
